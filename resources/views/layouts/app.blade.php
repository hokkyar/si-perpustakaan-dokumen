...
<body class="g-sidenav-show bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('upload') ? 'active' : '' }}" href="/upload">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('gdrive-setup') ? 'active' : '' }}" href="/gdrive-setup">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Ganti Drive</span>
                    </a>
                </li>
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item dropdown pe-2 d-flex align-items-center">
                            <a href="#" class="nav-link text-body p-0" id="dropdownMenuButton"
                                ...
                                <svg style="margin: 3px 4px;" xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4">
                                <li>
                                    <a href="/settings" style="vertical-align: middle" class="dropdown-item">
                                        ...
                                        <span class="mx-2" style="color: black;">Pengaturan</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('logout') }}" style="vertical-align: middle"
                                        class="dropdown-item">
                                        ...
                                        <span class="mx-2 text-danger">Logout</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
    ...
    <script>
        let table = new DataTable('#fileList', {
            searching: false,
            order: [
                [0, 'desc']
            ],
            ...
            language: {
                ...
                info: '', // Showing 1 to 5 of 5 entries
            }
        });
    </script>
